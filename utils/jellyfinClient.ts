...
export const initApi = (baseUrl: string, token: string) => {
  ...
  const api = {
    ...
    dlna: jellyfinApi.getDlnaApi(client),
    dlnaServer: jellyfinApi.getDlnaServerApi(client),
    ...
    imageByName: jellyfinApi.getImageByNameApi(client),
    ...
    notifications: jellyfinApi.getNotificationsApi(client),
